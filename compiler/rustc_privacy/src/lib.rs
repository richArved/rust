...
struct EmbargoVisitor<'tcx> {
    ...
    /// Correspondence between type and impls containing this type.
    type_to_impls: FxHashMap<LocalDefId, FxHashSet<LocalDefId>>,
}
